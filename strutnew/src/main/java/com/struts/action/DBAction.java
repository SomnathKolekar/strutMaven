...
public class DBAction {
	...
	public void createTables() {
		...
		st1.executeUpdate("DROP TABLE IF EXISTS book");
		 ...
		 st3.executeUpdate("CREATE TABLE book(book_id varchar2(30),book_name varchar2,book_author"
		 		+ " varchar2(30),book_price int)");
		...
		PreparedStatement ps1= conn.prepareStatement("INSERT INTO book VALUES(?,?,?,?)");
			...
			ps1.setInt(4, 5000);
			ps1.executeUpdate();	
		System.out.println("User and book records inserted...");
